...
from secrets import misp_url, misp_key
...
class RiskIQ_Sunburst_Finder():
 ...
 oMo   :mMMMMMMm`  `sMs...-::-`   `/h:   oy`  :NM:   /NMMN/   `+hh.   `  .dMMM-''') 
        ...
        print (style.RESET+style.BLUE+"⣿                                                                             ⣿")
        print (style.RESET+style.BLUE+"⣿"+style.UNDERLINE+style.MAGENTA+" MISP Operations"+"                                                             "+style.RESET+style.BLUE+"⣿")
        print (style.RESET+style.BLUE+"⣿                                                                             ⣿")
        print (style.BOLD+style.MAGENTA+"④"+style.BLUE +" ", style.RESET+style.BLUE+"   ["+style.MAGENTA+"MISP"+style.RESET+style.BLUE+"]", style.RESET+style.WHITE+"- Upload findings to MISP "+style.BLUE+   "                                       ⣿")
        print (style.RESET+style.BLUE+"⣿                                                                             ⣿")
    ...
    def sunburst_misp(self):
        mispevent = input(style.RESET+style.MAGENTA+'[MISP Event]'+style.RESET+style.CYAN+' Enter Event ID: '+style.WHITE).strip('\n')
        pymisp = ExpandedPyMISP(misp_url, misp_key)
        outfile = Path('output/').glob('**/*.json')
        for tosend in outfile:
            print(style.YELLOW+'Sending',tosend,'to MISP!')
            with open(tosend, 'r') as f: 
                result = pymisp.freetext(mispevent, f.read())
                print(style.GREEN+'Successfully sent to MISP!')
                print(style.CYAN+'Visit '+misp_url+'events/view/'+mispevent+' to access the event.')    
        print(style.RESET)        
